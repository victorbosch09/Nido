...
const QUOTES = [
  ...
  "Un equipo de dos puede mover montañas — y también lavar los platos.",
  "El presupuesto es un mapa, no una jaula. Recorrámoslo juntos.",
